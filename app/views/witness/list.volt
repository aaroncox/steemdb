            ...
            <tbody>
              {% for witness in witnesses %}
                <tr class="{{ witness.row_status }}">
                  ...
                  <td>
                    <div class="ui header">
                      {% if witness.sbd_exchange_rate.base === "0.000 GOLOS" or witness.last_sbd_exchange_update_late %}<i class="warning sign icon" data-popup data-title="Outdated Price Feed" data-content="This witness has not submitted a price feed update in over a week."></i>{% endif %}
                      <div class="content">
                        {{ witness.sbd_exchange_rate.base }}
                        {% if witness.sbd_exchange_rate.quote != "1.000 GOLOS" %}
