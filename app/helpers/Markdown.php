...
class Markdown
{
  ...
  static public function string($string)
  {
    ...
    $string = strip_tags($string, "<div><iframe><del><a><p><b><q><br><ul><li><ol><img><h1><h2><h3><h4><h5><h6><hr><blockquote><pre><code><em><strong><center><table><thead><tbody><tr><th><td><strike><sup><sub>");
